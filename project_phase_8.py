...
def add_d():
    ...
    df=df.append({'username':d1,'password':d2},ignore_index=True)
    d=df1.shape[0]
    df.index += d+1
...
def delete_user():
    ...
    Button(delete_u,text="Delete",height="2",width=10,bd=1,command=deleting).place(relx=0.5,rely=0.5,anchor=CENTER)

    Button(delete_u,text="Return to Admin page",height="2",width=20,bd=1,command=call_admind).place(relx=0.5,rely=0.6,anchor=CENTER)
...
#ADMIN page
Ad_data=pd.DataFrame(columns=['username','password'])
#admin login tab
def Adminlogintab():
...
def Admin():
    ...
    Button(admin,text="Add User",height="1",width=10,bd=1,command=call_adduser).place(relx=0.5,rely=0.45,anchor=CENTER)
    Button(admin,text="View Users",height="1",width=10,bd=1,command=call_viewers).place(relx=0.5,rely=0.5,anchor=CENTER)
    Button(admin,text="Delete User",height="1",width=10,bd=1,command=call_delete).place(relx=0.5,rely=0.55,anchor=CENTER)
    Button(admin,text="Return Home",height="1",width=10,bd=1,command=call_homea).place(relx=0.5,rely=0.6,anchor=CENTER)
...
def homepage():
    ...
    Button(home,text="ADMIN",height="3",width=10,bd=1,command=Adminlogintab).place(relx=0.45,rely=0.5,anchor=CENTER)
    Button(home,text="Trainer",height="3",width=10,bd=1,command=callogintab).place(relx=0.55,rely=0.5,anchor=CENTER)           
